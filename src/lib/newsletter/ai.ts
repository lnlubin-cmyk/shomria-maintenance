...
- "community" = הודעות והתרחשויות קהילתיות (אירועים, מזל טוב, הודעות אישיות, מכתבי מזכירות). כולל את לוח האירועים של השבועיים הקרובים (סיכום/לוח של האירועים הקרובים) — סמן אותו כ-"community" עם הכותרת „לוח אירועים”.
...
2. לוח האירועים של השבועיים הקרובים → החזר אותו עם section="community" והכותרת „לוח אירועים”.
